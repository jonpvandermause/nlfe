...
net_file = '../nn/saved_models/one_layer_10_0'
...
for p in range(phi_array.shape[0]):
    for q in range(phi_array.shape[0]):
        ...
        test_input = one_layer_final(dihedrals, network)
...
f.savefig('/Users/jonpvandermause/Research/CV/nlfe/nlfe/figures/bayes_err.pdf',
